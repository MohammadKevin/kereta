...
import { User, Lock, Eye, EyeOff, Train, ArrowLeft, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setApiError('Terjadi kesalahan saat mendaftar.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen w-full bg-[#030712] text-slate-100 flex flex-col lg:flex-row font-sans antialiased selection:bg-cyan-500/30">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 overflow-hidden border-r border-blue-500/10">
        <div 
          ...
          style={{ 
            backgroundImage: `linear-gradient(to right, rgba(3, 7, 18, 0.85) 30%, rgba(2, 6, 23, 0.6) 100%), url('https://images.unsplash.com/photo-1474487548417-781cb71495f3?auto=format&fit=crop&w=1200&q=80')` 
          }}
        />
        ...
        <div className="relative z-10 max-w-lg w-full flex flex-col justify-between h-full">
          ...
          <div className="my-auto space-y-6">
            ...
            >
              Dapatkan akses penuh kemudahan pemesanan, pemantauan jadwal, dan manajemen kursi kereta secara digital.
            </motion.p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-16 relative overflow-hidden">
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="lg:hidden space-y-2">
            ...
            <p className="text-sm text-slate-400">Buat akun untuk menikmati semua layanan RailTicket.</p>
          </div>
          ...
          >
            ...
            {isSuccess && (
              <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-sm rounded-xl flex items-start gap-3 animate-fadeIn">
                ...
                <span className="font-medium">Pendaftaran berhasil. Silakan login.</span>
              </div>
            )}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-950/80 text-sm font-medium text-slate-100 placeholder-slate-500 pl-11 pr-4 py-3 rounded-xl border transition-all duration-200 outline-none ${
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-950/80 text-sm font-medium text-slate-100 placeholder-slate-500 pl-11 pr-11 py-3 rounded-xl border transition-all duration-200 outline-none ${
